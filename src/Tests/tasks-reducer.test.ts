...
import {tasksReducer, TasksStateType, tasksThunks} from "../store/reducer/task-reducer/tasks-reducer";
import {todolistsActions, todolistThunks} from "../store/reducer/todolists-reducer/todolists-reducer";
